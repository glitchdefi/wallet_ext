...
import type { KeyringOptions } from './types.js';
import { ForageStorage } from './stores/index.js';
export declare class Base {
    #private;
    protected _forageStore: ForageStorage;
    ...
    protected initKeyring(options: KeyringOptions): Promise<void>;
    protected addAccountPairs(): Promise<void>;
